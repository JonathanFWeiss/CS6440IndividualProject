    ...
    client.request("DiagnosticReport?" + query2, {
        ...
        function(medResults) {
            ...
            medResults.forEach(function(med) {
                ...
                if (test.display == "CT Coronary Calcium"){displayMedication("<button class=\"open-button\" onclick=\"openForm_CAD()\">Infective Endocarditis Assessment</button>")}



                if (test.display == "CTA Coronary Arteries"){displayMedication("<button class=\"open-button\" onclick=\"openForm_CAD()\">Infective Endocarditis Assessment</button>")}
                ...
                if (test.display == "U.S. standard certificate of death - 2003 revision"){displayMedication("<button class=\"open-button\" onclick=\"openForm_AHW()\">Infective Endocarditis Assessment</button>")}


                if (test.display == "Lipid Panel"){displayMedication("<button class=\"open-button\" onclick=\"openForm_CC()\">Infective Endocarditis Assessment</button>")}


                if (test.display == "Lipid Panel"){displayMedication("<button class=\"open-button\" onclick=\"openForm_S()\">Infective Endocarditis Assessment</button>")}


                if (test.display == "Lipid Panel"){displayMedication("<button class=\"open-button\" onclick=\"openForm_D()\">Infective Endocarditis Assessment</button>")}
                ...
                if (test.display == "Lipid Panel"){displayMedication("<button class=\"open-button\" onclick=\"openForm_CD()\">Infective Endocarditis Assessment</button>")}


                if (test.display == "Lipid Panel"){displayMedication("<button class=\"open-button\" onclick=\"openForm_M()\">Infective Endocarditis Assessment</button>")}


                if (test.display == "Lipid Panel"){displayMedication("<button class=\"open-button\" onclick=\"openForm()\">Infective Endocarditis Assessment</button>")}

                if (test.display == "Lipid Panel"){displayMedication("<button class=\"open-button\" onclick=\"openForm_CLD()\">Infective Endocarditis Assessment</button>")}
            });
