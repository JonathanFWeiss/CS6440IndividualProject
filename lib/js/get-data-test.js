...
medResults.forEach(function(med) {
 ...
 // displayMedication(med.code.coding.pop().code);
  ...
  displayMedication(" ");
  if (test.display == "MRI Lumbar Spine without Contrast"){displayMedication("<button class=\"open-button\" onclick=\"openForm()\">Low Back Pain MRI Assessment</button>")}

  if (test.display == "Basic Metabolic Panel"){displayMedication("<button class=\"open-button\" onclick=\"openForm()\">Low Back Pain MRI Assessment</button>")}
